...
(async () => {
  ...
  console.log('   ✓ Filled gross tonnage');
  
  await page.fill('input[name="maxPersons"]', '8');
  console.log('   ✓ Filled max persons');
