#!/usr/bin/env node
/**
 * Process "to convert" folder images
 * Continues numbering from workboat-16
 */
...
const SOURCE_DIR = path.join(__dirname, '..', 'Workboat Pics', 'To Convert');
...
async function main() {
  console.log('🚢 SeaReady Image Processor - "to convert" folder\n');
  ...
  let imageNum = 16; // Continue from workboat-16
  ...
  for (const file of files) {
    ...
    console.log(`[${imageNum - 15}/${files.length}] ${file} → ${baseName}`);
