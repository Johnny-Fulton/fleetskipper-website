...
export const metadata: Metadata = {
  ...
  description: 'How SeaReady collects, uses, and protects your personal information.',
}
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section id="information" className="mb-12">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="bg-blue-50 border-l-4 border-blue-500 p-6 mb-4">
                  <h4 className="font-semibold text-gray-900 mb-2">Using Our Services:</h4>
                  <ul className="list-disc pl-6 space-y-1 text-gray-700">
                ...
                <div className="bg-blue-50 border-l-4 border-blue-500 p-6">
                  <h4 className="font-semibold text-gray-900 mb-2">Consultancy Services:</h4>
                  <ul className="list-disc pl-6 space-y-1 text-gray-700">
              ...
              <div>
                ...
                <div className="bg-gray-50 border-l-4 border-gray-400 p-6">
                  <h4 className="font-semibold text-gray-900 mb-2">Application Usage:</h4>
                  <ul className="list-disc pl-6 space-y-1 text-gray-700">
              ...
              <div>
                ...
                <div className="bg-green-50 border-l-4 border-green-500 p-6 mb-4">
                  <h4 className="font-semibold text-gray-900 mb-2">Payment Providers:</h4>
                  <p className="text-gray-700">Payment confirmation and transaction details (from Stripe or similar)</p>
                </div>

                <div className="bg-green-50 border-l-4 border-green-500 p-6">
                  <h4 className="font-semibold text-gray-900 mb-2">Authentication Providers:</h4>
                  <p className="text-gray-700">If you sign in using Google/Microsoft, we receive basic profile information (name, email)</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section id="sharing" className="mb-12">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="bg-blue-50 border-l-4 border-blue-500 p-6 mb-4">
                  <h4 className="font-semibold text-gray-900 mb-3">Service Providers (Data Processors):</h4>
                  <ul className="list-disc pl-6 space-y-2 text-gray-700">
                    <li><strong>Hosting providers</strong> (AWS, Azure, or similar - UK/EU regions only)</li>
                    <li><strong>Email services</strong> (Google Workspace)</li>
                    <li><strong>Payment processors</strong> (Stripe - PCI-DSS compliant)</li>
                    <li><strong>Analytics tools</strong> (privacy-focused only, no personal data shared)</li>
                  </ul>

                  <p className="text-gray-700 mt-4 mb-2 font-semibold">All third-party processors:</p>
                  <ul className="list-disc pl-6 space-y-1 text-gray-700">
                    <li>Are GDPR compliant</li>
                    <li>Have Data Processing Agreements (DPAs) in place</li>
                    <li>Store data in UK/EU only</li>
                  </ul>
                </div>
          ...
          <section id="retention" className="mb-12">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-300 border border-gray-300">
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  <tr>
                    <td className="px-4 py-3 text-sm text-gray-700 border-r border-gray-300">Account data</td>
                  ...
                  <tr>
                    <td className="px-4 py-3 text-sm text-gray-700 border-r border-gray-300">SMS records</td>
                  ...
                  <tr>
                    <td className="px-4 py-3 text-sm text-gray-700 border-r border-gray-300">Financial records</td>
                  ...
                  <tr>
                    <td className="px-4 py-3 text-sm text-gray-700 border-r border-gray-300">Support communications</td>
                  ...
                  <tr>
                    <td className="px-4 py-3 text-sm text-gray-700 border-r border-gray-300">Marketing data</td>
                  ...
                  <tr>
                    <td className="px-4 py-3 text-sm text-gray-700 border-r border-gray-300">Logs (security, access)</td>
          ...
          <section id="rights" className="mb-12">
            ...
            <div className="space-y-4">
              <div className="bg-green-50 border-l-4 border-green-500 p-6">
                <h3 className="font-semibold text-gray-900 mb-2">7.1 Right of Access</h3>
                <p className="text-gray-700">Request a copy of your personal data we hold (free, within 30 days)</p>
              </div>

              <div className="bg-green-50 border-l-4 border-green-500 p-6">
                <h3 className="font-semibold text-gray-900 mb-2">7.2 Right to Rectification</h3>
                <p className="text-gray-700">Correct inaccurate or incomplete data</p>
              </div>

              <div className="bg-green-50 border-l-4 border-green-500 p-6">
                <h3 className="font-semibold text-gray-900 mb-2">7.3 Right to Erasure (&quot;Right to be Forgotten&quot;)</h3>
                <p className="text-gray-700">Request deletion of your data (subject to legal retention requirements)</p>
              </div>

              <div className="bg-green-50 border-l-4 border-green-500 p-6">
                <h3 className="font-semibold text-gray-900 mb-2">7.4 Right to Restrict Processing</h3>
                <p className="text-gray-700">Limit how we use your data in certain circumstances</p>
              </div>

              <div className="bg-green-50 border-l-4 border-green-500 p-6">
                <h3 className="font-semibold text-gray-900 mb-2">7.5 Right to Data Portability</h3>
                <p className="text-gray-700">Receive your data in machine-readable format (CSV, JSON)</p>
              </div>

              <div className="bg-green-50 border-l-4 border-green-500 p-6">
                <h3 className="font-semibold text-gray-900 mb-2">7.6 Right to Object</h3>
                <p className="text-gray-700">Object to processing based on legitimate interest (e.g., marketing)</p>
              </div>

              <div className="bg-green-50 border-l-4 border-green-500 p-6">
                <h3 className="font-semibold text-gray-900 mb-2">7.7 Right to Withdraw Consent</h3>
                <p className="text-gray-700">If we rely on consent, you can withdraw it anytime</p>
              </div>

              <div className="bg-green-50 border-l-4 border-green-500 p-6">
                <h3 className="font-semibold text-gray-900 mb-2">7.8 Right to Complain</h3>
                <p className="text-gray-700">Lodge a complaint with the ICO (see Section 15)</p>
              </div>
            </div>
          ...
          <section id="breaches" className="mb-12">
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              ...
              <li>We have Cyber Liability Insurance covering up to [Amount to be confirmed]</li>
          ...
          <section id="cookies" className="mb-12">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-gray-300 border border-gray-300">
                    ...
                    <tbody className="divide-y divide-gray-200 bg-white">
                      <tr>
                        <td className="px-4 py-3 text-sm text-gray-700 border-r border-gray-300">Essential</td>
                      ...
                      <tr>
                        <td className="px-4 py-3 text-sm text-gray-700 border-r border-gray-300">Performance</td>
                      ...
                      <tr>
                        <td className="px-4 py-3 text-sm text-gray-700 border-r border-gray-300">Functional</td>
              ...
              <div>
                ...
                <p className="text-gray-700 mb-2">We may use:</p>
                <ul className="list-disc pl-6 space-y-1 text-gray-700">
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>Change settings anytime via cookie preferences</li>
          ...
          <section id="transfers" className="mb-12">
            ...
            <div className="bg-green-50 border-l-4 border-green-500 p-6 mb-4">
              <p className="text-gray-900 font-semibold mb-2">We do NOT transfer your data outside the UK/EU.</p>
              <p className="text-gray-700">All data is stored in UK/EU data centers (AWS London region or equivalent).</p>
            </div>

            <p className="text-gray-700 mb-2">If we need to transfer data internationally in future (e.g., for support services), we will:</p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
          ...
          <section id="children" className="mb-12">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-500 p-6">
              <p className="text-gray-900 font-semibold mb-3">Our services are NOT intended for children under 16.</p>
          ...
          <section id="changes" className="mb-12">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-6 mb-4">
              <p className="text-gray-900 font-semibold mb-2">When we make changes:</p>
              <ul className="list-disc pl-6 space-y-1 text-gray-700">
            ...
            <p className="text-gray-700 italic">Previous versions available on request.</p>
          </section>
          ...
          <section id="complaints" className="mb-12">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-6 mb-4">
              ...
              <ul className="space-y-2 text-gray-700">
                <li><strong>Website:</strong> <a href="https://ico.org.uk" className="text-sea-teal hover:underline" target="_blank" rel="noopener noreferrer">ico.org.uk</a></li>
          ...
          {/* Section 16: Maritime-Specific Considerations */}
          <section id="maritime" className="mb-12">
            ...
            <div className="space-y-6">
              <div className="bg-cyan-50 border-l-4 border-cyan-500 p-6">
                <h3 className="font-semibold text-gray-900 mb-3">For SMS (Safety Management System) customers:</h3>
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <div className="bg-cyan-50 border-l-4 border-cyan-500 p-6">
                <h3 className="font-semibold text-gray-900 mb-3">For consultancy clients:</h3>
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
          ...
          <div className="mt-12 border-t border-gray-200 pt-8">
            ...
            <p className="text-sm text-gray-600 mt-2">
              Latest version available at: <a href="https://seaready.co.uk/privacy-policy" className="text-sea-teal hover:underline">https://seaready.co.uk/privacy-policy</a>
            </p>
          </div>
