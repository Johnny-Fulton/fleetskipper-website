...
![Pilot using digital MPX tablet on vessel bridge](/images/empx/mpx-pilots-20.png)
...
**The typical pilot's morning:** On a cold, dark morning at 0500. You finish one vessel, disembark to the pilot boat, and within minutes you transfer to another vessel. By the time you reach the bridge, the captain is already full ahead. The master hands you a crumpled bit of card. You're scribbling vessel details on a bit of paper while simultaneously checking the berth instructions—which changed 20 minutes ago—and trying to confirm the vessel status with the master. The tug is already on station asking for confirmation. The paper MPX form gets sidelined in favour of concentrating on the job at hand.
...
| Scenario | Paper-Based MPX | Electronic MPX (eMPX) |
|----------|-----------------|----------------------|
| **Berth change 30 mins before arrival** | Pilot has outdated information; discovers change on bridge | Auto-synced from PMIS; pilot sees current berth before boarding |
| **Back-to-back pilotages** | Rush to fill form on bridge; incomplete data | Vessel details pre-populated; review on launch, ready on arrival |
| **UKC calculation** | Mental arithmetic or calculator while vessel is moving | Calculated automatically with current tidal height |
| **Tug assignments** | Phone call to confirm; manual note | Already populated from harbour system |
...
- **Safety Guardrails:** Configurable minimum UKC thresholds trigger warnings. Pilots must explicitly confirm critical values before form submission.
...
| IMPA Requirement | SeaReady eMPX |
|-----------------|---------------|
...
|------|-----------------|
| **PPU** | Real-time navigation, positioning, rate-of-turn, AIS overlay |
| **eMPX** | Pre-boarding planning, information exchange, documentation, audit trail |
...
![SeaReady eMPX interface showing vessel details and digital signatures](/images/empx/mpx-interface-2.png)

---

**About SeaReady:** SeaReady develops maritime software solutions focused on safety, compliance, and operational efficiency. The eMPX application is designed for deployment at ports and harbour authorities worldwide.

*For more information, visit [seaready.co.uk](https://seaready.co.uk)*