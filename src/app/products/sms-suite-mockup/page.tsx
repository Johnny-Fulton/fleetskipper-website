...
export const metadata: Metadata = {
  title: 'SeaReady SMS Suite™ - Complete SMS Platform | SeaReady Ltd [MOCKUP]',
...
export default function SMSSuiteMockupPage() {
  return (
    <div className="bg-white">
      ...
      <div className="bg-yellow-100 border-b-4 border-yellow-400 py-3">
        <div className="mx-auto max-w-7xl px-6 text-center">
          <p className="text-sm font-bold text-yellow-900">
            🎨 MOCKUP PREVIEW - This is not the live page
          </p>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <div>
              ...
              {/* UPDATED TAGLINE - Added "Even offline" */}
            ...
            <div className="relative">
              <div className="aspect-[4/3] rounded-2xl bg-gradient-to-br from-cyan-100 to-cyan-50 flex flex-col items-center justify-center shadow-xl border-4 border-dashed border-cyan-300">
                <Smartphone className="w-32 h-32 mb-4" style={{ color: '#0891B2' }} />
                <p className="text-sm font-semibold" style={{ color: '#0891B2' }}>
                  📸 DECK SCREENSHOT PLACEHOLDER
                </p>
                <p className="text-xs mt-2 px-4 text-center" style={{ color: '#6B7280' }}>
                  Tablet or phone mockup showing Deck interface
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-gradient-to-br from-teal-50 to-white py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            ...
            {/* PLACEHOLDER IMAGE AREA - Main Dashboard */}
            <div className="order-last lg:order-first relative">
              <div className="aspect-[4/3] rounded-2xl bg-gradient-to-br from-teal-100 to-teal-50 flex flex-col items-center justify-center shadow-xl border-4 border-dashed border-teal-300">
                <Monitor className="w-32 h-32 mb-4" style={{ color: '#14b8a6' }} />
                <p className="text-sm font-semibold" style={{ color: '#14b8a6' }}>
                  📸 OFFICE DASHBOARD SCREENSHOT
                </p>
                <p className="text-xs mt-2 px-4 text-center" style={{ color: '#6B7280' }}>
                  Main dashboard showing stats, reviews, activity
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                {/* NEW FEATURE - Risk Assessment Viewer */}
                <div className="flex items-start gap-3">
      ...
      {/* ADDITIONAL OFFICE SCREENSHOTS SECTION */}
      <div className="bg-white py-16">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-12">
            <h3 className="text-2xl font-bold" style={{ color: '#0E1A2B' }}>SeaReady Office in Action</h3>
          </div>

          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {/* Document Library Screenshot */}
            <div className="rounded-xl overflow-hidden shadow-lg">
              <div className="aspect-[4/3] bg-gradient-to-br from-gray-100 to-gray-50 flex flex-col items-center justify-center border-4 border-dashed border-gray-300">
                <FileText className="w-16 h-16 mb-2" style={{ color: '#14b8a6' }} />
                <p className="text-xs font-semibold px-4 text-center" style={{ color: '#14b8a6' }}>
                  📸 DOCUMENT LIBRARY
                </p>
              </div>
              <div className="p-4 bg-white">
                <p className="text-sm font-semibold" style={{ color: '#0E1A2B' }}>Document Library</p>
                <p className="text-xs mt-1" style={{ color: '#6B7280' }}>Chapter organisation & document tiles</p>
              </div>
            </div>

            {/* Risk Assessment Viewer Screenshot */}
            <div className="rounded-xl overflow-hidden shadow-lg">
              <div className="aspect-[4/3] bg-gradient-to-br from-gray-100 to-gray-50 flex flex-col items-center justify-center border-4 border-dashed border-gray-300">
                <FileSpreadsheet className="w-16 h-16 mb-2" style={{ color: '#14b8a6' }} />
                <p className="text-xs font-semibold px-4 text-center" style={{ color: '#14b8a6' }}>
                  📸 RISK ASSESSMENT VIEWER
                </p>
              </div>
              <div className="p-4 bg-white">
                <p className="text-sm font-semibold" style={{ color: '#0E1A2B' }}>Risk Assessment Viewer</p>
                <p className="text-xs mt-1" style={{ color: '#6B7280' }}>Clean display of Excel RAs with colour-coded risk levels</p>
              </div>
            </div>

            {/* Review Matrix Screenshot */}
            <div className="rounded-xl overflow-hidden shadow-lg">
              <div className="aspect-[4/3] bg-gradient-to-br from-gray-100 to-gray-50 flex flex-col items-center justify-center border-4 border-dashed border-gray-300">
                <Calendar className="w-16 h-16 mb-2" style={{ color: '#14b8a6' }} />
                <p className="text-xs font-semibold px-4 text-center" style={{ color: '#14b8a6' }}>
                  📸 REVIEW MATRIX
                </p>
              </div>
              <div className="p-4 bg-white">
                <p className="text-sm font-semibold" style={{ color: '#0E1A2B' }}>Review Tracking Matrix</p>
                <p className="text-xs mt-1" style={{ color: '#6B7280' }}>What&apos;s due, coming up, or overdue</p>
              </div>
            </div>
          </div>
        </div>
