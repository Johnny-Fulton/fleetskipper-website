...
export default function HomePage() {
  return (
    <>
      ...
      {/* 1. HERO SECTION */}
      <section className="relative bg-gradient-to-br from-navy via-navy-dark to-navy py-20 md:py-28">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Link
                ...
                className="bg-orange hover:bg-orange-dark text-white px-8 py-4 rounded-lg font-semibold text-lg transition-colors shadow-lg"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white p-8 rounded-xl shadow-card text-center">
              <div className="bg-orange/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <FileText className="text-orange" size={32} />
              </div>
              <h3 className="text-xl font-bold text-navy mb-3">Drowning in Paperwork?</h3>
            ...
            <div className="bg-white p-8 rounded-xl shadow-card text-center">
              <div className="bg-orange/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <ClipboardCheck className="text-orange" size={32} />
              </div>
              <h3 className="text-xl font-bold text-navy mb-3">Not Sure Where to Start?</h3>
              <p className="text-body-text">
            ...
            <div className="bg-white p-8 rounded-xl shadow-card text-center">
              ...
              <h3 className="text-xl font-bold text-navy mb-3">Worried About MCA Inspections?</h3>
              <p className="text-body-text">
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-navy to-navy-light text-white p-8 md:p-10 rounded-2xl shadow-lg">
              <div className="bg-teal/20 w-16 h-16 rounded-xl flex items-center justify-center mb-6">
                <FileText className="text-teal" size={32} />
              </div>
              <h3 className="text-2xl md:text-3xl font-bold mb-2">SMS Consultancy Services</h3>
              <p className="text-xl text-teal mb-6">Get Compliant Fast</p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/services"
                  className="bg-orange hover:bg-orange-dark text-white px-6 py-3 rounded-lg font-semibold transition-colors text-center"
                >
                  Get Quote
                </Link>
                <Link
            ...
            {/* FleetSkipper App */}
            <div className="bg-gradient-to-br from-teal to-teal-dark text-white p-8 md:p-10 rounded-2xl shadow-lg">
              ...
              <p className="text-xl text-navy mb-6">Go Digital, Stay Compliant</p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/contact"
                  className="bg-white hover:bg-gray-100 text-teal px-6 py-3 rounded-lg font-semibold transition-colors text-center"
                >
                  Book Demo
                </Link>
                <Link
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-2 lg:order-1">
                <div className="bg-gradient-to-br from-navy to-navy-light rounded-2xl p-8 aspect-square flex items-center justify-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <ul className="space-y-4 mb-8">
                  <li className="flex items-start gap-3">
                    <CheckCircle size={24} className="text-teal flex-shrink-0 mt-1" />
                    <span className="text-lg text-body-text">20+ years maritime operations</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle size={24} className="text-teal flex-shrink-0 mt-1" />
                    <span className="text-lg text-body-text">Active Belfast Harbour pilot</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle size={24} className="text-teal flex-shrink-0 mt-1" />
                    <span className="text-lg text-body-text">Real-world operator, not just a consultant</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle size={24} className="text-teal flex-shrink-0 mt-1" />
                    <span className="text-lg text-body-text">WBC3 & MGN 280 compliance expert</span>
                  </li>
                </ul>

                <blockquote className="border-l-4 border-teal pl-6 py-4 bg-white rounded-r-lg shadow-sm">
                  <p className="text-lg text-body-text italic mb-4">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                <div className="bg-teal text-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 text-2xl font-bold">
                  1
                </div>
                <h3 className="text-xl font-bold text-navy mb-4">Book Free Consultation</h3>
                <p className="text-body-text mb-6">
                  15-minute call to understand your vessels and compliance needs
                </p>
                <Link
                  href="/contact#book-consultation"
                  className="inline-block bg-orange hover:bg-orange-dark text-white px-6 py-3 rounded-lg font-semibold transition-colors"
                >
                  Book Now
                </Link>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-navy mb-4">We Build Your SMS</h3>
                <p className="text-body-text">
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-navy mb-4">You're MCA-Ready</h3>
                <p className="text-body-text">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white/10 backdrop-blur-sm p-8 md:p-10 rounded-2xl border border-white/20">
              ...
              <footer className="text-teal font-semibold">
      ...
      {/* 7. LEAD MAGNET */}
      <section id="lead-magnet" className="py-16 md:py-20 bg-gradient-to-br from-orange to-orange-dark text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link
              href="/contact"
              className="inline-block bg-white hover:bg-gray-100 text-orange px-8 py-4 rounded-lg font-bold text-lg transition-colors shadow-lg"
            >
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="border-t border-gray-300 pt-8">
              <p className="text-body-text mb-4">Or contact directly:</p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <a href="mailto:jonathan@fleetskipper.com" className="flex items-center gap-2 text-navy hover:text-teal transition-colors">
                  <Mail size={20} />
                  <span>jonathan@fleetskipper.com</span>
                </a>
                <a href="tel:+447446858414" className="flex items-center gap-2 text-navy hover:text-teal transition-colors">
                  <Phone size={20} />
