...
export default function FVCrewCheckerPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('/api/fishing-vessel/crew-check', {
        method: 'POST',
      ...
      router.push('/tools/fishing-vessel/crew-checker/results')
    } catch (err) {
                ...
                <div className="bg-white rounded-2xl p-8 shadow-sm border-2 border-gray-200">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="part_decked">Part Decked</option>
                    </select>
                  </div>
                </div>
