...
export const metadata: Metadata = {
  ...
  description: 'Terms and conditions for using SeaReady maritime compliance software and services.',
}
        ...
        <div className="mx-auto max-w-4xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
            {[
              ...
              {id: 'modifications', title: '14. Modifications to Services & Terms'},
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section id="services" className="mb-12">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-semibold mb-3 text-gray-900">2.1 Software-as-a-Service (SaaS):</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-gray-900">2.2 Digital Products:</h3>
                <ul className="list-disc pl-6 space-y-1 text-gray-700">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-gray-900">2.3 Consultancy Services:</h3>
                <ul className="list-disc pl-6 space-y-1 text-gray-700">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-1 text-gray-700">
                  ...
                  <li>Payment is overdue (greater than 30 days)</li>
          ...
          <section id="subscription" className="mb-12">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-700 mt-3">Current pricing: seaready.co.uk/pricing</p>
              </div>
          ...
          <section id="use" className="mb-12">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-700 mt-4">
                  See also: <Link href="/acceptable-use" className="text-sea-teal hover:underline">Acceptable Use Policy</Link>
                </p>
              </div>
          ...
          <section id="data" className="mb-12">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-700">
                  Our <Link href="/privacy" className="text-sea-teal hover:underline">Privacy Policy</Link> explains how we handle your data.
                </p>
              </div>
          ...
          <section id="service-level" className="mb-12">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-700">
                  We target 99.5% uptime per month (see <Link href="/sla" className="text-sea-teal hover:underline">SLA</Link>)
                </p>
              </div>
          ...
          <section id="termination" className="mb-12">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-700">These Terms remain in effect while you use our services.</p>
              </div>
          ...
          <section id="warranties" className="mb-12">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-3">EXCEPT AS ABOVE, SERVICES ARE PROVIDED &quot;AS IS&quot; WITHOUT WARRANTIES:</p>
                <ul className="list-disc pl-6 space-y-1 text-gray-700">
              ...
              <div>
                ...
                <div className="bg-yellow-50 border-l-4 border-yellow-500 p-6">
                  <p className="text-gray-700 mb-3 font-semibold">IMPORTANT: While our SMS tools are designed to assist with regulatory compliance (MCA, WBC3, etc.):</p>
          ...
          <section id="indemnification" className="mb-12">
            ...
            <p className="text-gray-700 mb-4 font-semibold">You agree to indemnify SeaReady against claims arising from:</p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
          ...
          <div className="mt-8 p-6 bg-gray-50 border border-gray-200 rounded-lg">
            <p className="text-gray-700 mb-3 font-semibold">Acceptance</p>
            <p className="text-gray-700">
          ...
          <div className="mt-12 border-t border-gray-200 pt-8">
            ...
            <p className="text-sm text-gray-600 mt-4 italic">
              Latest version available at: <a href="https://seaready.co.uk/terms" className="text-sea-teal hover:underline">https://seaready.co.uk/terms</a>
            </p>
          </div>
